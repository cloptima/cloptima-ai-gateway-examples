def attribution_headers(
    ...
    """Maps demo-friendly fields to the managed-gateway attribution headers
    used by these examples. The global environment guide lists telemetry-only
    dimensions separately. A key configured with team/app/environment does
    not need those values repeated on every call.
    """
    fields = {
